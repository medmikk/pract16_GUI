...
public class ControllerEditInternetOrder {
    ...
    private ObservableList<Order> typeOrderList = FXCollections.observableArrayList(DataContainer.internetOrdersManager.getOrders());
    ...
    private void updateVBox() {
        ...
        if(!itemsList.isEmpty()) {
            ...
            DataContainer.internetOrdersManager.remove();
            cancelButtonOnClick();
        }
    }
